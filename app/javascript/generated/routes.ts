...
/** /top/index(.:format) */
export function topIndexPath(options?: object): string {
  return "/" + "top" + "/" + "index" + ($hasPresentOwnProperty(options, "format") ? "." + (options as any).format : "") + $buildOptions(options, ["format"]);
}
